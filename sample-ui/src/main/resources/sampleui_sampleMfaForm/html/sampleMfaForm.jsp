...
<div id="mfa-container" class="mfa-form-container">
    <div class="mfa-header">
        <h2>${formTitle}</h2>
        <div id="error-message" data-testid="error-message" class="error-message" style="display: none;"></div>
    ...
    <div id="step-login" class="mfa-step active">
        <form id="login-form" class="mfa-form">
            <div class="form-group">
                ...
                <input data-testid="login-username" type="text" id="username" name="username" required autocomplete="username">
            </div>
            <div class="form-group">
                <label for="password">${passwordLabel}:</label>
                <input data-testid="login-password" type="password" id="password" name="password" required autocomplete="current-password">
            </div>
            <button data-testid="login-submit" type="submit" class="mfa-button primary">${loginButton}</button>
        </form>
    </div>
    ...
    <div id="step-factors" class="mfa-step">
        <div class="factor-selection">
            ...
            <div id="available-factors" data-testid="available-factors" class="factors-list">
...
class MfaForm {
    ...
    showFactorSelection() {
        ...
        this.availableFactors.forEach((factor, index) => {
            ...
            // add attribute for Cypress
            button.setAttribute('data-testid', factor + '-select-factor-button');
