 ...
 */
export function createSiteWithLoginPage(siteKey: string, languages = [DEFAULT_LANGUAGE], serverName = 'localhost') {
    deleteSite(siteKey);
    ...
    cy.login();
    cy.visit(`/cms/editframe/default/${siteLanguage}/sites/${siteKey}/${LOGIN_PAGE_NAME}.html?redirect=false`);
