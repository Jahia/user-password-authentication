...
export const I18N = {
    ...
    locales: {
        en: {
            ...
            'complete.successful': 'Authentication Successful!',
            'complete.redirect_url': 'Redirect URL: <code>{{redirectUrl}}</code>',
            'complete.redirecting_countdown': 'Redirecting in {{countdown}} seconds...',
            'complete.redirecting_go_label': 'Go now',
